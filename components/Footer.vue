<template>
    <footer class="footer">
                ...
                <div>
                    ...
                    <div class="liste-reseaux">
                        <div>
                            ...
                            <a class="lien" href="https://www.facebook.com/essoccercoach" target="_blanc"><font-awesome-icon :icon="['fab', 'facebook-square']"/></a>
                            <a class="lien" href="https://www.youtube.com/channel/UC7tPGITAH1B0UYVS5vbhOmQ" target="_blanc"><font-awesome-icon :icon="['fab', 'youtube-square']"/></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="copyrigth-footer">
            <span>© Copyrigth ESsoccercoach 2022</span>
        </div>
    </footer>
</template>
<script>
